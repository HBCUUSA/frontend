...
const Sidebar = ({
  ...
  >
    ...
    <div className={`p-6 ${isSidebarCollapsed ? 'lg:px-4' : ''}`}>
      <nav className="">
        <div className="space-y-2">
          ...
          >
            ...
            <span className={`ml-3 ${isSidebarCollapsed ? 'lg:hidden' : ''}`}>Programs</span>
          </Link>
          <Link to="/experience"
            className={`flex items-center px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg transition-colors
            ${isSidebarCollapsed ? 'lg:justify-center' : ''}`}
          ...
          >
            ...
            <span className={`ml-3 ${isSidebarCollapsed ? 'lg:hidden' : ''}`}>Experience</span>
          </Link>
          <Link to="/hbcu"
            className={`flex items-center px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg transition-colors
            ${isSidebarCollapsed ? 'lg:justify-center' : ''}`}
          ...
          >
            ...
            <span className={`ml-3 ${isSidebarCollapsed ? 'lg:hidden' : ''}`}>HBCU</span>
          </Link>
          <Link to="/about"
            className={`flex items-center px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg transition-colors
            ${isSidebarCollapsed ? 'lg:justify-center' : ''}`}
          ...
          >
            ...
            <span className={`ml-3 ${isSidebarCollapsed ? 'lg:hidden' : ''}`}>About</span>
          </Link>
          <div className={`py-2 ${isSidebarCollapsed ? 'lg:hidden' : ''}`}>
            <p className="px-4 text-xs font-semibold text-gray-400 uppercase tracking-wider">Add Programs</p>
          </div>
          {isSidebarCollapsed && (
            <div className="py-2 hidden lg:flex justify-center">
          ...
          >
            ...
            <span className={`ml-3 ${isSidebarCollapsed ? 'lg:hidden' : ''}`}>Add New Program</span>
          </Link>
          <Link to="/resume"
            className={`flex items-center px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg transition-colors
            ${isSidebarCollapsed ? 'lg:justify-center' : ''}`}
          ...
          >
            ...
            <span className={`ml-3 ${isSidebarCollapsed ? 'lg:hidden' : ''}`}>Upload Resume</span>
          </Link>
          ...
          >
            ...
            <span className={`ml-3 ${isSidebarCollapsed ? 'lg:hidden' : ''}`}>Browse Resumes</span>
          </Link>
          <Link to="/mentor"
            className={`flex items-center px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg transition-colors
            ${isSidebarCollapsed ? 'lg:justify-center' : ''}`}
          ...
          >
            ...
            <span className={`ml-3 ${isSidebarCollapsed ? 'lg:hidden' : ''}`}>Find Mentors</span>
          </Link>
          {user && (
            ...
            >
              ...
              <span className={`ml-3 ${isSidebarCollapsed ? 'lg:hidden' : ''}`}>My Contributions</span>
            </Link>
          )}
        </div>
      </nav>
