...
const Footer = () => {
  return (
    <footer className="bg-blue-800 dark:bg-gray-900 text-white py-4 mt-auto">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap items-center justify-between">
          <div className="text-s md:text-sm">
            <p>©2024 Copyright: All Rights Reserved by HBCUUSA</p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden md:flex space-x-4 text-s">
