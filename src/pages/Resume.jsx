    ...
    <div className="relative min-h-screen bg-white flex">
      ...
      <div className="relative z-10 flex-1">
        ...
        <div className={`transition-all duration-300 ${isSidebarCollapsed ? 'lg:pl-20' : 'lg:pl-64'}`}>
          <div className="min-h-screen bg-transparent dark:bg-gray-900 py-6 md:py-12">
            <div className="max-w-4xl mx-auto px-4">
              ...
              {!user ? (
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-5 md:p-8 text-center">
                  <p className="text-base md:text-lg text-gray-700 dark:text-gray-300 mb-6">
                    Please log in to manage your resume
                  </p>
                  <a 
                    href="/login" 
                    className="inline-block px-5 py-2 md:px-6 md:py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition"
                  >
                    Log In
                  </a>
                </div>
                ...
                <>
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-5 md:p-8 mb-6">
                    <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-6">
                      <p className="text-gray-700 dark:text-gray-300 mb-4 md:mb-0 md:mr-4 text-sm md:text-base">
                      ...
                      <Link 
                        to="/public-resumes"
                        className="inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 whitespace-nowrap"
                      >
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg shadow-sm p-4 md:p-6 border border-blue-100 dark:border-blue-800">
